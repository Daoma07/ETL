const { conexionOrigenDB } = require("/db/conexion");
 ...
 *  */
const Zona = conexionOrigenDB.define(
    "zonas",
    {
        id_zona: {
 ...
 * */
const TipoJuicio = conexionOrigenDB.define(
    "tipos_juicios",
    {
        id_tipo_juicio: {
            type: DataTypes.INTEGER,
 ...
 * @property {string} estado_civil
  */
const EstadoCivil = conexionOrigenDB.define(
    "estados_civiles",
    {
        id_estado_civil: {
            type: DataTypes.INTEGER,
 ...
 * */
const Genero = conexionOrigenDB.define(
    "generos",
    {
        id_genero: {
            type: DataTypes.INTEGER,
 ...
 * */
const Motivo = conexionOrigenDB.define(
    "motivos",
    {
        id_motivo: {
            type: DataTypes.INTEGER,
 ...
 * */
const CatalogoRequisito = conexionOrigenDB.define(
    "catalogo_requisitos",
    {
        id_catalogo: {
            type: DataTypes.INTEGER,
 ...
 * @property {number} id_genero
 * */
const Persona = conexionOrigenDB.define(
    "personas",
    {
        id_persona: {
            type: DataTypes.INTEGER,
...
const DetalleAsesoriaCatalogo = conexionOrigenDB.define(
 ...
 * */
const Turno = conexionOrigenDB.define(
    "turnos",
    {
        id_turno: {
            type: DataTypes.INTEGER,
 ...
 * */
const Asesorado = conexionOrigenDB.define(
    "asesorados",
    {
        id_asesorado: {
            type: DataTypes.INTEGER,
 ...
 * */
const Domicilio = conexionOrigenDB.define(
    "domicilios",
    {
        id_domicilio: {
            type: DataTypes.INTEGER,
 ...
 * */
const MunicipioDistro = conexionOrigenDB.define(
...
const Empleado = conexionOrigenDB.define(
    "empleados",
    {
        id_empleado: {
            type: DataTypes.INTEGER,
 ...
 * @property {number} id_zona
 * */
const Asesor = conexionOrigenDB.define(
    "asesores",
    {
        id_asesor: {
            type: DataTypes.INTEGER,
...
const Defensor = conexionOrigenDB.define(
    "defensores",
    {
        id_defensor: {
            type: DataTypes.INTEGER,
 ...
 * @property {number} id_municipio_distrito
 * */
const DistritoJudicial = conexionOrigenDB.define(
 ...
 * @property {number} id_tipo_juicio
 */
const Asesoria = conexionOrigenDB.define(
    "asesorias",
    {
        id_asesoria: {
            type: DataTypes.INTEGER,
