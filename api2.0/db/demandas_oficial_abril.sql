CREATE DATABASE  IF NOT EXISTS `defensoria_demandas` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `defensoria_demandas`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: defensoria_demandas
-- ------------------------------------------------------
...
INSERT INTO `domicilio_participante` VALUES (1,'Argentina','279','',21225,1),(2,'Alberto Vargas','2909','',107729,2);
...
INSERT INTO `escolaridad` VALUES (1,'BASICA','ACTIVO'),(2,'MEDIA','ACTIVO');
...
INSERT INTO `estado_procesal` VALUES (1,'Prueba 1','2024-04-07',1);
...
INSERT INTO `etnia` VALUES (1,'Yaqui','ACTIVO'),(2,'Mayos','ACTIVO');
...
INSERT INTO `familiar` VALUES (1,'Julia Antonieta','Mexicana','Madre',1,1,1,1,1);
...
CREATE TABLE `imputado` (
  ...
  CONSTRAINT `imputado_ibfk_1` FOREIGN KEY (`id_imputado`) REFERENCES `participante` (`id_participante`)
...
INSERT INTO `juzgado` VALUES (1,'Juzgado 1','ACTIVO'),(2,'Juzgado 2','ACTIVO');
...
INSERT INTO `observacion` VALUES (1,'Prueba 3',1);
...
INSERT INTO `ocupacion` VALUES (1,'Albañil','ACTIVO'),(2,'Ingeniero','ACTIVO');
...
INSERT INTO `participante` VALUES (1,'Juan','Pérez','García',25,'644123456',2,1),(2,'Judith','Orozco','Hernandez',45,'4354534545',1,1);
...
INSERT INTO `proceso_judicial` VALUES (1,'2024-04-08',NULL,'cccccddddd','aaaaabbbbb',2,1,60,10,13,'EN_TRAMITE',1);
...
INSERT INTO `promovente` VALUES (1,1,1,1,1);
...
INSERT INTO `prueba` VALUES (1,'Prueba 2',1);
...
INSERT INTO `resolucion` VALUES (1,'Prueba 4','2024-04-07',1);
...
-- Dump completed on 2024-04-07 22:26:18
