const { conexionCodigosPostalesDB } = require("../db/conexion"); // Import the connection to the database

const { DataTypes, Model } = require("sequelize"); // Import the built-in data types

const Estado = conexionCodigosPostalesDB.define(
  "estados",
  {
...
const Municipio = conexionCodigosPostalesDB.define(
  "municipios",
  {
...
const Ciudad = conexionCodigosPostalesDB.define(
  "ciudades",
  {
...
const CodigoPostal = conexionCodigosPostalesDB.define(
  "codigos_postales",
  {
...
const Colonia = conexionCodigosPostalesDB.define(
  "colonias",
  {
